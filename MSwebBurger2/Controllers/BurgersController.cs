...
namespace MSwebBurger2.Controllers
{
    public class BurgersController : Controller
    {
        private readonly MSwebBurger2Context _context;

        public BurgersController(MSwebBurger2Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("BurgerID,Name,WithCheese,Price,PriceCelling")] Burger burger)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("BurgerID,Name,WithCheese,Price,PriceCelling")] Burger burger)
        {
